...
function onEdit(e) {
  bhBijWijzigingVoorpagina(e);
  return bhBijWijzigingAdressen(e);
}
...
function mnBijOpenen() {
  ...
  mainMenu.addSubMenu(ui.createMenu("Beheer").addItem("Controleer spreadsheet", "bhControleerSpreadsheet").addItem("Initialiseer ontbrekende structuur", "bhInitialiseerSpreadsheet").addItem("Werk Adressen bij", "bhWerkAdressenBij").addItem("Migreer Voorpagina (eenmalig)", "bhMigreerVoorpagina").addItem("Herstel bronnen van draaitabellen", "bhHerstelDraaitabelbronnen").addItem("Controleer en herbereken Voorpagina", "bhControleerEnHerberekenVoorpagina").addSeparator().addItem("Schoon Configuratie op", "bhSchoonConfiguratieOp").addItem("Controleer projectconfiguratie", "bhControleerProjectConfiguratie"));
